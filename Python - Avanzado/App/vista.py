...
class Ventana:
    def __init__(self, window):
        ...
        self.server_power_on = ttk.Button(self.input_frame, text="Prender", command=lambda: my_server.try_connection(), width=10)
        self.server_power_on.grid(row=5, column=0, padx=5, pady=5)

        self.server_power_off = ttk.Button(self.input_frame, text="Apagar", command=lambda: my_server.stop_server(), width=10)
